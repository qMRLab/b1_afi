...
function ExportBlock(input,inputRaw,trName){
  ...
  reconKeys = [
    ...
    "mri.SessionBIDS",
    "mri.AcquisitionBIDS",
    "equipment.scannerDeviceSerialNumber",
    ...
    "equipment.gradient/siemens/asGPAParameters_0/flDefGradMinRiseTimeNominal",
    ...
    "equipment.gradient/siemens/flGSWDPhaseEncodingLines_0",
    "equipment.gradient/siemens/flGSWDPhaseEncodingLines_1",
    "equipment.gradient/siemens/flGSWDPhaseEncodingLines_2",
    "equipment.gradient/siemens/flGSWDtd_0_0",
    "equipment.gradient/siemens/flGSWDtd_0_1",
    "equipment.gradient/siemens/flGSWDtd_0_2",
    "equipment.gradient/siemens/flGSWDtd_0_3",
